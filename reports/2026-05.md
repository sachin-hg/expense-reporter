...
| --- | --- | --- | --- |
| Travel | ₹13,748 | ₹16,069 | ₹27,920 |
| Trip | (₹13,492) | (₹62,371) | (₹174,432) |
| Shopping | ₹12,717 | ₹15,086 | ₹24,160 |
| Baby | ₹1,050 | ₹25,305 | ₹2,380 |
| Outside Food | ₹16,425 | ₹12,583 | ₹44,124 |
...
xychart-beta
    ...
    line "Travel" [12.1, 16.5, 16.1, 27.9, 13.7]
    line "Trip" [0.0, 722.3, -62.4, -174.4, -13.5]
    line "Shopping" [7.8, 17.5, 15.1, 24.2, 12.7]
    line "Baby" [7.7, 5.6, 25.3, 2.4, 1.0]
    line "Outside Food" [9.5, 7.6, 12.6, 44.1, 16.4]
    line "Grocery" [2.9, 3.5, 4.7, 5.3, 3.2]
    line "Utilities & Bills" [11.5, 33.2, 12.6, 21.7, 12.3]
    line "Health, Fitness & Self Care" [25.5, 18.6, 2.5, 4.4, 2.3]
    line "Upskill / AI" [2.6, 2.5, 2.6, 0.4, 42.6]
    line "Rohan" [24.8, 19.3, 32.0, 33.1, 89.6]
    line "One-Time Expense" [0.0, 25.8, 0.0, 0.0, 99.7]
    line "Tax" [0.0, 0.0, 30.3, 0.0, 0.0]
    line "Others" [6.0, 20.1, 5.2, -80.9, 18.1]
```
