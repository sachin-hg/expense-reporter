...
| --- | --- | --- | --- |
| Travel | ₹13,292 | ₹15,877 | ₹27,303 |
| Trip | (₹10,229) | (₹67,871) | (₹174,432) |
| Shopping | ₹26,816 | ₹10,616 | ₹24,220 |
| Baby | ₹1,050 | ₹25,305 | ₹2,380 |
| Outside Food | ₹16,881 | ₹12,117 | ₹20,252 |
| Grocery | ₹3,187 | ₹4,743 | ₹3,379 |
| Utilities & Bills | ₹12,317 | ₹12,566 | ₹21,311 |
| Health, Fitness & Self Care | ₹2,274 | ₹2,455 | ₹4,419 |
| Upskill / AI | ₹42,608 | ₹2,570 | ₹399 |
| Rohan | ₹56,604 | ₹32,039 | ₹33,099 |
| One-Time Expense | ₹99,711 | ₹0 | ₹4,968 |
| Tax | ₹195 | ₹30,255 | ₹296 |
| Others | ₹529 | ₹5,872 | ₹4,267 |
| **Total** | **₹265,235** | **₹86,545** | **(₹28,139)** |
...
xychart-beta
    ...
    line "Travel" [12.2, 16.5, 15.9, 27.3, 13.3]
    line "Trip" [0.0, 722.3, -67.9, -174.4, -10.2]
    line "Shopping" [7.8, 16.4, 10.6, 24.2, 26.8]
    line "Baby" [7.7, 5.6, 25.3, 2.4, 1.0]
    line "Outside Food" [9.5, 7.6, 12.1, 20.3, 16.9]
    line "Grocery" [2.5, 4.5, 4.7, 3.4, 3.2]
    line "Utilities & Bills" [11.5, 33.2, 12.6, 21.3, 12.3]
    line "Health, Fitness & Self Care" [25.5, 18.3, 2.5, 4.4, 2.3]
    line "Upskill / AI" [2.6, 2.5, 2.6, 0.4, 42.6]
    line "Rohan" [24.8, 19.3, 32.0, 33.1, 56.6]
    line "One-Time Expense" [0.0, 25.8, 0.0, 5.0, 99.7]
    line "Tax" [0.0, 0.0, 30.3, 0.3, 0.2]
    line "Others" [6.3, 20.3, 5.9, 4.3, 0.5]
```
...
| May 02 | Trent | — | ₹449 |
| May 06 | SmartBuy | — | ₹3,000 |
| May 06 | Myntra | — | ₹3,095 |
| May 07 | Myntra (FSN Brands) | ICICI Emeralde | ₹1,274 |
...
| May 03 | Shri Ram Paneer | Paytm | ₹276 |
...
| May 31 | GoIbibo Flight (Rohan) | — | — | ₹46,744 |
